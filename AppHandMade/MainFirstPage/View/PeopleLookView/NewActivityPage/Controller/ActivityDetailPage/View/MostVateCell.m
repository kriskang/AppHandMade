...
#import "MostVateColCell.h"
#import "UIImageView+WebCache.h"
#import "HeaderBase.h"

#define secondColor [UIColor colorWithRed:255/255.0 green:240/255.0 blue:240/255.0 alpha:1.0]

@interface MostVateCell ()<UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, retain) UICollectionView *collectionView;
@property (nonatomic, retain) UICollectionViewFlowLayout *flowLayout;

@end
@implementation MostVateCell
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.collectionView registerClass:[MostVateColCell class] forCellWithReuseIdentifier:@"mostVateColCell"];
        [_collectionView release];
...
{
    MostVateColCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"mostVateColCell" forIndexPath:indexPath];
